<template>
  ...
  <div class="row" style="margin-top: 200px">
    <div class="col">
      ...
      <div class="code-block2 row">
        <div class="col-lg-6">Maitrise du Framework ?</div>
        <div class="col-lg-6">Apprentissage ?</div>
        <div class="col-lg-6">Interet ?</div>
        <div class="col-lg-6">Fuite ?</div>
      </div>
    </div>
    <div class="col">
      <Carousel/>
